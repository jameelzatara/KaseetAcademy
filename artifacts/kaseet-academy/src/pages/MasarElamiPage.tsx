        ...
        <div style={WRP}>
          <div style={SH}>
            ...
            <p style={{ fontFamily: F, fontSize: 14.5, color: MUT, maxWidth: 580, marginInline: 'auto', marginTop: 10, lineHeight: 1.85 }}>
              برنامج متكامل يأخذك من التأسيس وحتى إنتاج فيلم إعلامي احترافي. اختر بين الحضور المباشر في الاستوديو أو الأونلاين التفاعلي.
            </p>
          </div>
          ...
          <div style={{ maxWidth: 600, margin: '52px auto 0', position: 'relative' }}>
            ...
            <div style={{ position: 'relative', background: '#131B27', border: `1px solid ${GL}`, borderRadius: 26, overflow: 'hidden', boxShadow: '0 0 0 1px rgba(255,193,7,.12), 0 34px 70px rgba(13,11,20,.45)' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', borderBottom: `1px solid ${CBR}` }}>
                <button onClick={() => setCheckoutMode('onsite')}
                  style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4, padding: '18px 16px', border: 'none', cursor: 'pointer', background: checkoutMode === 'onsite' ? 'rgba(255,193,7,.08)' : 'transparent', borderBottom: checkoutMode === 'onsite' ? `2px solid ${GLD}` : '2px solid transparent', transition: 'background .2s, border-color .2s' }}>
                ...
                <button onClick={() => setCheckoutMode('live')}
                  style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4, padding: '18px 16px', border: 'none', cursor: 'pointer', background: checkoutMode === 'live' ? 'rgba(103,232,249,.07)' : 'transparent', borderBottom: checkoutMode === 'live' ? '2px solid #67e8f9' : '2px solid transparent', transition: 'background .2s, border-color .2s', borderRight: `1px solid ${CBR}` }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              ...
              <div style={{ padding: 'clamp(24px,3.5vw,36px)' }}>
                ...
                <p style={{ fontFamily: F, fontSize: 13.5, color: LT, textAlign: 'center', margin: '0 0 22px', lineHeight: 1.7, minHeight: 42 }}>
                  {checkoutMode === 'onsite'
                    ? <>40 ساعة تدريبية بـ<strong style={{ color: GLD }}>700 ديناراً</strong> — أي <strong style={{ color: GLD }}>17.5 دينار للساعة فقط</strong></>
                    : <>40 ساعة تدريبية تفاعلية — <strong style={{ color: '#67e8f9' }}>حضور مباشر من أي مكان بالعالم</strong></>
                  }
                </p>
                ...
                <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 12, padding: 0, margin: '0 0 24px' }}>
                  {[
                    ...
                    'فيلم إعلامي مكتمل كمشروع التخرّج',
                ...
                <button
                  ...
                  style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, width: '100%', boxSizing: 'border-box', background: GLD, color: '#0f172a', fontFamily: F, fontWeight: 800, fontSize: 15.5, padding: '16px 24px', borderRadius: 16, border: 'none', cursor: 'pointer', boxShadow: '0 8px 28px rgba(255,193,7,.30)', transition: 'transform .15s, box-shadow .15s' }}
