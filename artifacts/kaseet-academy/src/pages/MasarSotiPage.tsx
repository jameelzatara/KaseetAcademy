...
const PHASE_BANDS = [
  { from:0, to:3, label:'المرحلة الأولى', sub:'التأسيس · 12 ساعة · 6 جلسات', color: GLD },
  { from:3, to:10, label:'المرحلة الثانية', sub:'التخصّصات · 26 ساعة · 10 جلسات', color: '#67e8f9' },
  { from:10, to:12, label:'المرحلة الثالثة', sub:'الاحتراف والسوق · 4 ساعات · جلستان', color: '#a78bfa' },
];
...
const FAQS = [
  ...
  { q:'هل أحتاج استوديو ومعدّات خاصة؟',
    a:'لا في الحضوري، إذ تُسجّل في استوديو كاسيت. وفي الدراسة عن بُعد، المحطة الثالثة مخصّصة لتعليمك تجهيز مساحة تسجيل مقبولة بأقلّ تكلفة. أمّا مشروع التخرّج فيُهندَس بيد مهندس الصوت في الحالتين.' },
  ...
  return (
    <div dir="rtl" className="page-masar-canvas" style={{ fontFamily: F, color: OFF, minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      <div style={{ ...WRP, paddingTop: 18, paddingBottom: 0 }}>
        <button onClick={() => navigate('/')} aria-label="العودة إلى الصفحة الرئيسية"
